...
class BaseInfo(models.Model): #Model abstract
...
class Category(BaseInfo):
    class Meta(BaseInfo.Meta): #Model inheritance
...
class Provider(BaseInfo): #Model inheritance
...
class Order(models.Model):
    ...
    product_name = models.CharField(max_length=100, default="Laptop")
